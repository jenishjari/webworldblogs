 ...
 */
get_header(); ?>
<div id="main-content" class="main-content blog-page blog-list <?php echo esc_attr(freshcodes_sidebar_position()); ?> <?php echo esc_attr(freshcodes_page_layout()); ?>">
